...
const BidStack = createStackNavigator();
  ...
  class Quiggly extends Component {
  constructor(props) {
    super(props);
    }
  ...
  createDrawerNavigator = () => {
    ...
    return(
      <Drawer.Navigator initialRouteName={initialScreen}>
        ...
        <Drawer.Screen name={"Home"} component={this.HomeStackScreen}/>
...
// connect() connects the counter prop we created in mapStateToProp to QuigglyApp props.
  export default connect(mapStateToProps,mapDispatchToProps)(Quiggly);
